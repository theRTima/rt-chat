...
Для 10,000 concurrent WebSocket соединений необходимо увеличить лимит открытых файловых дескрипторов. Скрипт содержит комментарии с инструкциями для macOS и Linux в начале `main.go`.
## React Frontend
...
- [x] Нагрузочное тестирование (10K соединений)
